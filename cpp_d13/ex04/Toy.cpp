...
// Last update Tue Jan 17 08:59:44 2017 clement xia
//
...
{
  this->picture.data = as;
  return (*this);
}

std::ostream&	operator<<(std::ostream& os, const Toy& to)
{
  os << to.getName() << std::endl << to.getAscii() << std::endl;
  return (os);
}
